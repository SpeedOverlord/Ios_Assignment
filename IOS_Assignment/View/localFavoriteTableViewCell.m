...
@interface localFavoriteTableViewCell() {
...
@implementation localFavoriteTableViewCell {
}
...
-(void)setReadMore {
    ...
    self.readMoreUpperBond = [self.readMore.topAnchor constraintEqualToAnchor: self.removeFavorite.bottomAnchor constant: 15];
